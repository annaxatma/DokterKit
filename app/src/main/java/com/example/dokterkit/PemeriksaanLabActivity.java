...
public class PemeriksaanLabActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        pLab_imageView_back = findViewById(R.id.pLab_imageView_back);
        plab_imageView_info = findViewById(R.id.plab_imageView_info);
        ...
        pLab_button_save = findViewById(R.id.pLab_button_save);
    }
